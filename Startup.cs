        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                context.Users.AddRange(new List<User>()
                {
                    ...
                    new User(){Name = "Juan", Lastname = "Reyes", PhotoUrl = "https://image.flaticon.com/icons/png/512/206/206879.png", Email = "email1@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new User(){Name = "Miguel", Lastname = "Sanchez", PhotoUrl = "https://www.jamf.com/jamf-nation/img/default-avatars/generic-user-purple.png", Email = "email2@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new User(){Name = "Rossmery", Lastname = "Rosario", PhotoUrl = "http://www.etnahitech.com/new/wp-content/uploads/2017/09/businessman-1.png", Email = "email3@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new User(){Name = "Laura", Lastname = "Feliz", PhotoUrl = "https://i1.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1", Email = "email4@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new User(){Name = "Rosanna", Lastname = "Cortorreal", PhotoUrl = "https://upload.wikimedia.org/wikipedia/commons/d/d3/User_Circle.png", Email = "email5@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new User(){Name = "Antonio", Lastname = "Tejada", PhotoUrl = "https://apps.odoo.com/apps/icon_image?module_id=37439", Email = "email6@hotmail.com", Password = "password123", Gender = "Hombre", Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 }
                });
                context.SaveChanges();
            }
            ...
            if (!context.Comments.Any())
            {
                ...
                {
                    new Comment(){Text = "Comentario 1", NewsFeedId = 1, UserId = 2, Hour = 15, Minute = 43, Day = 7, Month = 6, Year = 2018 },
                    new Comment(){Text = "Comentario 2", NewsFeedId = 2, UserId = 1,  Hour = 16, Minute = 44, Day = 8, Month = 7, Year = 2018 },
                    new Comment(){Text = "Comentario 3", NewsFeedId = 3, UserId = 3,  Hour = 17, Minute = 45, Day = 9, Month = 8, Year = 2018 },
                    new Comment(){Text = "Comentario 4", NewsFeedId = 2, UserId = 2,  Hour = 18, Minute = 46, Day = 10, Month = 9, Year = 2018 },
                    new Comment(){Text = "Comentario 5", NewsFeedId = 3, UserId = 4,  Hour = 19, Minute = 47, Day = 11, Month = 10, Year = 2018 },
                    new Comment(){Text = "Comentario 6", NewsFeedId = 1, UserId = 5,  Hour = 20, Minute = 48, Day = 12, Month = 11, Year = 2018 }                 
                });
                context.SaveChanges();
            }
